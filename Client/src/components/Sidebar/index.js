...
const Sidebar = () => {
  ...
  return (
    <div>
      <Menu>
        <div>
          <h3>This is a burger Menu. More features to come</h3>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <input
              ...
              id="monthlyIncome"
              value={monthlyIncome}
              onChange={handleChangeExpectedIncome}
            />
            ...
            <input
              ...
              id="expectedRent"
              value={expectedRent}
              onChange={handleChangeExpectedRent}
            />
            <label htmlFor="expectedUtilities">Expected Utilities</label>
            <input
              type="number"
              name="expectedUtilities"
              id="expectedUtilities"
              value={expectedUtilities}
              onChange={handleChangeExpectedUtilities}
            />
            ...
            <input
              ...
              id="expectedMisc"
              value={expectedMisc}
              onChange={handleChangeExpectedMisc}
            />
            ...
            <input
              ...
              id="expectedFood"
              value={expectedFood}
              onChange={handleChangeExpectedFood}
            />
            ...
            <input
              ...
              id="expectedGas"
              value={expectedGas}
              onChange={handleChangeExpectedGas}
            />
